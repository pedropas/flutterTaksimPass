...
class CustonPositionedRiderDetail extends StatefulWidget {
  const CustonPositionedRiderDetail({Key? key,required this.riderDetailContainerHeight, required this.displayRequestRideContainer}) : super(key: key);

  final double riderDetailContainerHeight;
  final Function displayRequestRideContainer;

  @override
  _CustonPositionedRiderDetailState createState() => _CustonPositionedRiderDetailState(riderDetailContainerHeight: riderDetailContainerHeight,
...
class _CustonPositionedRiderDetailState extends State<CustonPositionedRiderDetail> {
  ...
  _CustonPositionedRiderDetailState({required this.riderDetailContainerHeight, required this.displayRequestRideContainer });
